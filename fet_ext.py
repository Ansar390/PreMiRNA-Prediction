...
def cal_dibase_index(seq):
  dibase_index = {'aa':1,'ac':2,'au':3,'ag':4,'ca':5,'cu':6,'cc':7,'cg':8,'gg':9,'ga':10,'gc':11,'gu':12,'uu':13,'ua':14,'uc':15,'ug':16} 
...
# fname = r"C:\Users\DELL 3510\Downloads\plant stress\Independent_dataset\Independent_dataset\miRNA\test_.fasta"

# for seq_record in SeqIO.parse(fname, "fasta"):
#     seq = str(seq_record.seq)
#     print(str(i) + ': ' + seq)
#     if(set(seq).issubset(set(["A", "C", "U", "G", "a", "c", "g", "u"]))):
#       allFVs.append(calcFV(seq.lower()))
#       i = i + 1

# with open(r'C:\Users\DELL 3510\Downloads\plant stress\Independent_dataset\Independent_dataset\miRNA\test_.csv', mode='w') as fvFile:
